  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <div className="flex gap-6">
        <button 
          className={`option-button ${activeOption === 'productions' ? 'bg-secondary text-white' : 'bg-secondary/80 text-white'}`}
          onClick={() => setActiveOption(activeOption === 'productions' ? 'none' : 'productions')}
        >
          Productions
        </button>
        <button 
          className={`option-button ${activeOption === 'tools' ? 'bg-secondary text-white' : 'bg-secondary/80 text-white'}`}
